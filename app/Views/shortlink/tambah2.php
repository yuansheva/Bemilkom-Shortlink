...
<div class="container">
    <div class="row mt-5 align-items-center justify-content-center">
        <div class="col-md-7">
            ...
            <form method="post" action="tambahShortlink">
                <div class="row">
                    <div class="col-2"></div>
                    <div class="form-group col-md-8 mb-3">
                        <input type="url" class="form-control <?= ($validation->hasError('link')) ? 'is-invalid' : ''; ?>" id="link" name="link" placeholder="Enter your long URL">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-8">
                        <div class="form-group mb-3">
                            <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" placeholder="Enter your short URL">
                            <div class="invalid-feedback">
